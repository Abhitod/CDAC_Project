...
<div id="form-rightside-edit-part-in-payment">
    ...
    <label>pricing</label>
    <span className="name-of-the-span-css-for-payment-details">{Distance*perKm} Rs.</span><br></br>
    {/* <label>tax charges</label> 
    <span className="name-of-the-span-css-for-payment-details">304 RS</span><br></br> */}
    <hr></hr>
    <label className="name-of-the-span-css-for-payment-details-total-subtotal">Total</label> 
    <span className="name-of-the-span-css-for-payment-details-total">{Distance*perKm} Rs.</span><br></br> 
